        ...
        <Grid container className={classes.gridmain}>
          ...
          <Grid container className={`${classes.subGrid} ${"subgrid_one"}`}>
            <Grid item xs={12} md={6} className={classes.cantonContainer}>
              ...
              <Fade bottom>
                <Typography variant="subtitle1" className={classes.cantonText}>
                  We provide consultancy services to any Automotive, Tire, Steel
                  Foundries, Paint, Electrical, Electronics manufacturing
                  companies, Software Providers, Data Processing Centers,
                  Conical Research Organizations, Asset Recovery Centers, 3PL
                  providers and Banks.
                </Typography>
              </Fade>
            </Grid>
